...
int login()
{
    ...
    while (1)
    {
        ...
        {
            ofstream g("registration.txt"); /* ofstream is the one for getting data from the file, and the file does not even have to exist. If it's ofstream, it'll take care of it for you. but be warned that if there is a file called "registration.txt" in the name folder as the .exe file, the contents will be deleted*/
